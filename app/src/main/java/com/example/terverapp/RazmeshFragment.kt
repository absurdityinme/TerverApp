...
import com.example.terverapp.databinding.FragmentRazmeshBinding
import com.google.android.material.snackbar.Snackbar
import java.math.BigDecimal
import java.math.MathContext
import java.math.RoundingMode

class RazmeshFragment: Fragment(R.layout.fragment_razmesh) {
    private val viewBinding: FragmentRazmeshBinding by viewBinding(FragmentRazmeshBinding::bind)
    ...
    private fun calculate(n: Int, k: Int): BigDecimal {
        val numerator = factorial(n).toBigDecimal()
        val denominator = factorial(n - k).toBigDecimal()
